...
abstract class DataController extends Controller
{
	...
	{
		// The default task of a DataController is Browse
		if (($task === 'default') || $task === 'display')
		{
			$task = 'browse';
		}
    ...
    public function browse()
    {
	    ...
	    $view->limitStart = $this->input->get->getInt('limitstart', 0);
	    $view->limit      = $this->input->get->getInt('limit', WordPress::get_page_limit());
	    $view->items = $this->model->getItems(false, $view->limitStart, $view->limit);
