...
/**
 * An error handler based on modal dialogs. It requires you to set up a modal dialog div with id errorDialog.
 *
 * @param   {String}  error  The error message string
 */
akeeba.System.modalErrorHandler = function (error) {
	var dialog_element = document.getElementById(akeeba.System.params.errorDialogId);
 ...
 * @param  {callback}  successCallback  A function accepting a single object parameter, called on success
 * @param  {callback}  errorCallback    A function accepting a single string parameter, called on failure
 * @param  {boolean}   useCaching       Should we use the cache?
 * @param  {int}       timeout          Timeout before cancelling the request (default 60s)
 */
 ...
 * @param   {int}    timeout      How long before the notification disappears automatically, in seconds
 */
...
akeeba.System.data = (function () {
	...
	return {
		set: function (element, property, value) {
			...
			var dataAttributeName = "data-" + property.split(/(?=[A-Z])/)
				.join("-")
				.toLowerCase();
 ...
 *
 * @param   {Element|string}   element    The element to attach to (or its ID as a string)
 * @param   {String}           eventName  The event name to attach
 * @param   {callback}         listener   The event handler to attach
 */
 ...
 *
 * @param   {Element|string}   element    The element to detach from (or its ID as a string)
 * @param   {String}           eventName  The event name to detach
 * @param   {callback}         listener   The event handler to detach
 */
 ...
 *
 * @param   {Element|string}   element    The element to fire the event on
 ...
 * @param   {array|string}    newClasses  The classes to add, either as an array or as a space separated string
 */
...
/**
 * Remmove a CSS class from an element
 *
 * @param   {Element}         element     The element to remove CSS classes from
 * @param   {array|string}    oldClasses  The classes to remove, either as an array or as a space separated string
 */
...
/**
 * Does an element have a specific CSS class?
 *
 * @param    {Element}  element  The element to query
 * @param    {String}   aClass   The CSS class to check for
 *
 * @returns  {boolean}
 */
...
/**
 * Toggle the specified CSS class on the element. If the class exists it will be removed. If it does not exist, it will
 * be added.
 *
